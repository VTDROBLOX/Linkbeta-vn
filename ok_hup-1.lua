do
  ...
  Lv = (game.Players.LocalPlayer:FindFirstChild("Data") and game.Players.LocalPlayer.Data:FindFirstChild("Level") and game.Players.LocalPlayer.Data.Level.Value) or 0
...
pcall(function() plr.PlayerGui:WaitForChild("Main", 15) end)
...
local Remotes = {}
pcall(function()
    local Net = replicated:WaitForChild("Modules", 15):WaitForChild("Net", 15)
    Remotes.RFJobsRemoteFunction = Net:WaitForChild("RF/JobsRemoteFunction", 10)
    Remotes.RFCraft = Net:WaitForChild("RF/Craft", 10)
end)
