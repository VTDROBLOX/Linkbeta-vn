...
Tabs.Info:AddDiscordInvite({
	Title = "Tày Hub | community",
	Description = "A community for Tày Hub Users - official scripts, updates, and suport in one place.",
	Banner = "rbxassetid://96454140798208", 
	Logo = "rbxassetid://96454140798208",
	Invite = "https://discord.gg/ph5CznY9PU",
	Members = 18000, 
	Online = 560, 
})
                ...
                if tick() - _G.HopTimer >= _G.HopDelay then
                    ...
                    if syn and syn.queue_on_teleport then
                        syn.queue_on_teleport(
                            "(game:HttpGet('https://pastefy.app/iiFOhcot/raw'))()"
                        )
                    end
...
Tabs.Misc:AddSection("Translate (Google)")
local _TransText = ""
local _TransTo = "en"
local _TransLangs = {
    ["English"]="en", ["Vietnamese"]="vi", ["Chinese"]="zh-CN", ["Japanese"]="ja",
    ["Korean"]="ko", ["Thai"]="th", ["Spanish"]="es", ["French"]="fr",
    ["German"]="de", ["Russian"]="ru", ["Portuguese"]="pt", ["Indonesian"]="id",
    ["Arabic"]="ar", ["Hindi"]="hi", ["Italian"]="it", ["Filipino"]="tl",
}
local _TransLangNames = {}
for k in pairs(_TransLangs) do table.insert(_TransLangNames, k) end
...
local function _GTranslate(text, target)
    local url = "https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=" .. target .. "&dt=t&q=" .. _UrlEncode(text)
    ...
    if not ok or not res then return nil, "Loi ket noi" end
    -- Parse JSON kieu [[["dich","goc",...]],...]
    local out = ""
    pcall(function()
    ...
    if out == "" then return nil, "Khong dich duoc" end
    return out, nil
end
...
Window:Notify({
  Title = "Tày Hub",
  Content = "Tày hub TOP 3 SCRIPT FREE",
  Image = "rbxassetid://96454140798208",
  Duration = 5
})